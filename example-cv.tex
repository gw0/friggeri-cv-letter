...
%
% Modifications by gw0 [http://gw.tnode.com/] <gw.2018@ena.one>
%
% License:
% CC BY-NC-SA 3.0 (http://creativecommons.org/licenses/by-nc-sa/3.0/)
% 
% Important notes:
% This template needs to be compiled with XeLaTeX and Biber:
%
...
%\addbibresource{example-bibliography.bib} % Specify the bibliography file to include publications
